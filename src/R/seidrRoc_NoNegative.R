...
#' ```
res <- plotRoc(here("data/seidr/results/ROC_NoNegative/aggregated_roc.tsv"))
...
#' ```
files <- dir(here("data/seidr/results/ROC_NoNegative/"),pattern="backbone.*\\.tsv",full.names=TRUE)
...
#' ```
resh <- plotRoc(here("data/seidr/results/ROC_NoNegative/hardthreshold.roc.tsv"))
